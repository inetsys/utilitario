(function () {
    ...
    __constraints = {
        ...
        tillToday: function(str) {
            ...
            return this.dateBefore(str, date);
        },
        ...
        futureDate: function(str) {
            ...
            return this.dateAfter(str, date);
        },
        dateAfter: function (str, date) {
            ...
            console.log("dateAfter", str, date);
        ...
        dateBefore: function (str, date) {
            ...
            console.log("dateBefore", str, date);
        ...
        ip : function (val) {
            if (__constraints.ip4(val)) {
                return true;
            } else if (__constraints.ip6(val)) {
                return true;
            }
    ...
    __cast = {
        ...
        boolean: function (val) {
            return val === "true" || val === "false" || val === true || val === false || !!val;
        },
        binary: function (bin) {
    ...
    function __schema(mixed, structure, errors, options, __path) {
        ...
        if (mixed === undefined) {
            if (!constraints.optional) {
                errors[__path.join(".")] = [["is undefined"]];
            }
        ...
        if (constraints) {
            ...
            //console.log("errors", _errors, constraints);
