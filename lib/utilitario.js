(function () {
    ...
    constraints = {
        ...
        notContains: function (needle, haystack) {
            return !constraints.contains(needle, haystack);
        },
        equals: function (a, b) {
            return a == b;
        },
        ...
        dateAfter: function (str, date) {
            ...
            if (is.date(str)) {
                a = cast.date(str).getTime();
            } else {
                a = 0;
            }

            b = cast.date(date).getTime();
        ...
        alphanumeric: function (val) {
            if (is.numberStrict(val) && !is.nan(val)) {
                return true;
            }
